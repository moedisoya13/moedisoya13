...
### 브랜드 원색을 배경으로 옮길 때 — 밝기 램프로 편다

브랜드 색을 그대로 배경에 깔면 의도한 인상이 잘 안 나옵니다. **채도 높은 색을 낮은
알파로 넓게 깔면 채도가 먼저 빠져서** 화면이 탁한 중간색으로 내려앉습니다.
`#F7E26B`(레몬 노랑)를 90% 면적으로 깔았더니 올리브빛 회색이 됐습니다.

해법은 양이 아니라 **밝기 단계**입니다. 같은 색상(hue)을 밝기만 다르게 편 램프를
배경에 쓰고, 원색은 전경 포인트로 남깁니다.

```css
/* 브랜드 노랑 #F7E26B 를 4단으로 편 크림 램프 */
--gbg-palette:
  #F7E26B, #F7EAC0, #FBF3DC, #F2D98C, #F7EAC0, #FBF3DC,
  #F7E26B, #F7EAC0, #F2D98C, #FBF3DC, #F7EAC0, #F2D98C;
--gbg-base: #FBF6E9;
```

밝은 램프는 **색을 더 진하게 쓰면서 글자는 더 잘 읽히는** 구간을 엽니다.

| 구성 | blob 알파 | 본문 최저 대비 |
|---|---|---|
| 원색 3색, 레몬 90% | `intensity 0.3` | 8.5 : 1 |
| 크림 램프 | `intensity 0.7` | **10~15 : 1** |

알파를 두 배 넘게 올렸는데 대비가 오히려 올라갑니다.

**원색은 전경에서도 글자용과 면적용을 나눠야 합니다.** 밝은 노랑 바탕 위 실측입니다.

| 쓰임 | 색 | 대비 |
|---|---|---|
| 밑줄·칩 같은 면적 | `#E60012` | — (장식이라 기준 없음) |
| 작은 글자 | `#E60012` | 3.8 : 1 — AA 미달 |
| 작은 글자 | `#9E000C` | 6.7 : 1 |
| 보조 데이터 글자 | `#27551F` | 6.8 : 1 |
